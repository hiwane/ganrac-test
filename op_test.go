...
func TestOpRObj2(t *testing.T) {
	for i, s := range []struct {
		...
		{Sub, "-", NewPolyCoef(0, 5, 7), NewInt(3), NewPolyCoef(0, 2, 7)},
		{Sub, "-", NewInt(3), NewPolyCoef(0, 5, 7), NewPolyCoef(0, -2, -7)},
		{Sub, "-", NewPolyCoef(0, 2, 3, 11), NewPolyCoef(0, 5, 7), NewPolyCoef(0, -3, -4, 11)},

		{Add, "+", NewInt(10), NewInt(3), NewInt(13)},
		{Add, "+", NewPolyCoef(0, 5, 7), NewInt(3), NewPolyCoef(0, 8, 7)},
		{Add, "+", NewPolyCoef(0, 2, 3, 11), NewPolyCoef(0, 5, 7), NewPolyCoef(0, 7, 10, 11)},
		...
		{Mul, "*", NewPolyCoef(0, 5, 7), NewInt(3), NewPolyCoef(0, 15, 21)},
		{Mul, "*", NewPolyCoef(0, 2, 3, 11), NewPolyCoef(0, 5, 7), NewPolyCoef(0, 10, 29, 76, 77)},
